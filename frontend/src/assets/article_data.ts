  ...
  articles: [
    {
      id: 0,
      title:
        'BKK to test a unique digital solution in Hungary on the direct airport shuttle bus line in 2023',
      pic: i1,
      date: 'Budapest, 3 November 2022',
      content: `BKK Centre for Budapest Transport is about to take another step forward in the field of digitalization. Together with Mastercard, Monet+ and K&H, the mobility manager will be testing a technical solution that will make public transport even faster and easier. During the trial period, customers will need nothing more than a physical or digitized bankcard with contactless payment functionality on the 100E airport shuttle bus line.
      ...
      This solution is faster than traditional bankcard payments. In addition to the extremely short technical processing time, the new system also speeds up the purchase process by automatically charging the fare for the given ride - for example, the price of the Airport Shuttle Single Ticket on the 100E bus - to the customer's bankcard.`,
    },
    {
      id: 1,
      ...
      Journey planning while traveling in a vehicle
