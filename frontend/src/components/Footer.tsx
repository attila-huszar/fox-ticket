            ...
            <ul className="socialLinks">
              <li>
                <a href="" className="footerLink">
                  <TbBrandFacebook className="socialIcon" />
                </a>
              </li>
              <li>
                <a href="" className="footerLink">
                  <TbBrandInstagram className="socialIcon" />
                </a>
              </li>
              <li>
                <a href="" className="footerLink">
                  <TbBrandTwitter className="socialIcon" />
                </a>
              </li>
              <li>
                <a href="" className="footerLink">
                  <TbBrandTiktok className="socialIcon" />
                </a>
              </li>
            </ul>
            <p className="copyright">
              Copyright © {year} by Virides Caelestes. <br />
              All rights reserved.
            </p>
          </div>
